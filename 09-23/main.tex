...
\subsubsection{Introduzione alla ricerca operativa}
...
Decidiamo di modelizzare questa situazione con un modello matematico.
...
In questo caso le variabili decisiali saranno le quantità di laminato A e B da produrre, che individuano un punto in $ R^2 $ denominato $ ( x_A, x_B ) $. 
...
$$ f(x_A, x_B) = 8.4 x_A + 11.2 x_B, \quad f: R^2 \rightarrow R $$
...
A questo punto, possiamo disegnare la regione ammissbile come l'intersezione dei semipiani individuati da ogni singola disuguaglianza.
...
Il modello finora descritto prende il nome di modello di programmazione lineare.
