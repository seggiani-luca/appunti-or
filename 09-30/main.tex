...
\begin{definition}{Soluzione di base primale}
	Sia dato un problema LP $\mathcal{P}$ in forma primale standard con $n < m$.
...
\begin{theorem}{Caratterizzazione dei vertici primali}
	...
	$$ 
	x \in \mathrm{vert}(P) \Leftrightarrow \text{$x$ è soluzione di base primale}
	$$
\end{theorem}
